...
namespace LoadXmlTest
{
    ...
    // https://github.com/dotnet/corefx/blob/master/src/System.Security.Cryptography.Xml/src/System/Security/Cryptography/Xml/Signature.cs#L11
    class Signature
    {
        ...
        public void LoadXml(XmlElement value)
        {
            ...
            if (!signatureElement.LocalName.Equals("Signature"))
                throw new CryptographicException("Hej1", "Signature");
            ...
            if (!Utils.VerifyAttributes(signatureElement, "Id"))
                throw new CryptographicException("Hej2", "Signature");
            ...
            if (signedInfoNodes == null || signedInfoNodes.Count == 0 || signedInfoNodes.Count > 1)
                throw new CryptographicException("Hej3", "SignedInfo");
            ...
            if (signatureValueNodes == null || signatureValueNodes.Count == 0 || signatureValueNodes.Count > 1)
                throw new CryptographicException("Hej4", "SignatureValue");
            ...
            if (!Utils.VerifyAttributes(signatureValueElement, "Id"))
                throw new CryptographicException("Hej5", "SignatureValue");
            ...
            if (keyInfoNodes != null)
            {
                ...
                {
                    throw new CryptographicException("Hej6", "KeyInfo");
                }
            ...
            {
                throw new CryptographicException("Hej7", "Signature");
            }
        }
    }
}
